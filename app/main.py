...
# Create FastAPI app
app = FastAPI(
    title="Teler ELEVENLABS Bridge",
    description="A bridge application between Teler and ELEVENLABS for voice calls using media streaming.",
    version="1.0.0"
)
...
async def root():
    ...
    return {
        "message": "Teler ELEVENLABS Bridge is running", 
        "status": "healthy",
